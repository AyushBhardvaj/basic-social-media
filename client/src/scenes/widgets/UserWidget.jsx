        ...
        <WidgetWrapper>
            ...
            <Box p="1rem 0">
                ...
                <FlexBetween gap="1rem" mb="0.5rem">
                    <FlexBetween gap="1rem">
                        <img height="30px" weight="30px" src="http://localhost:3001/assets/twitter.png" alt="twitter" />
                        <Box>
                            <Typography color={main} fontWeight="500">
                                Twitter
                            </Typography>
                ...
                <FlexBetween gap="1rem">
                    <FlexBetween gap="1rem">
                        <img height="30px" weight="30px" src="http://localhost:3001/assets/linkedin.png" alt="linkedin" />
                        <Box>
                            <Typography color={main} fontWeight="500">
                                LinkedIn
                            </Typography>
